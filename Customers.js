...
module.exports = {
    verifyCardHasTitleManageCustomers: function() {
        ...
        expect($("fims-employee md-toolbar-row div").getText()).toEqual("Manage customer");
    },
    ...
    enterTextIntoDayOfBirthInputField: function(text) {
        birthDayInput.click().sendKeys(text);
    },
